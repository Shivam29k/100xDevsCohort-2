...
// in simple language inner join returns only the records that have a match in both tables are returned
// left join returns all records from the left table and the matched records from the right table if in any case there is no match the result will contain value from left table and null
// right join returns all records from the right table and the matched records from the left table if in any case there is no match the result will contain value from right table and null
